...
messy_data = NitroDataStore(
    {
        "user": {"name": "Alice", "email": None, "phone": "555-1234", "address": None},
        "settings": {"theme": "dark", "language": None, "notifications": True},
        "metadata": None,
...
cluttered_data = NitroDataStore(
    {
        ...
        "valid": {
            "value": 1,
            "nested": {"empty_dict": {}, "empty_list": [], "actual_value": "keep this"},
        },
        "items": [1, 2, 3],
        "more_empty": {},
    }
...
raw_data = NitroDataStore(
    {
        ...
        "settings": {"theme": None, "cache": {}, "features": {"a": 1, "b": None}},
    }
)
...
count = ecommerce_data.update_where(
    condition=lambda p, v: (
        ...
        any(
            prod.get("stock", 999) < 60 and prod.get("price") == v
...
old_config = NitroDataStore(
    {
        ...
        "database": {"host": "old-db.example.com", "port": 5432},
        "cache": {"enabled": False, "ttl": None},
    }
)
